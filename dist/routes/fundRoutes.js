...
router.post('/', [
    ...
    (0, express_validator_1.body)('minAmount').isNumeric().isFloat({ gt: 0 }), // Asegúrate de que sea un número positivo
    (0, express_validator_1.body)('category').isString().notEmpty(),
], fundController_1.createFund // Asocia el controlador 'createFund' para crear un fondo
);
/**
 * @swagger
 * /funds/{id}:
 ...
 */
router.delete('/:id', fundController_1.removeFund); // Asocia el controlador 'removeFund' para eliminar un fondo
/**
 * @swagger
 * /funds:
 *   get:
 ...
 */
router.get('/', fundController_1.listFunds); // Asocia el controlador 'listFunds' para listar los fondos
/**
 * @swagger
 * /funds/{fundId}:
 *   get:
 ...
 */
router.get('/:id', fundController_1.getFundsByFundId); // Ruta actualizada para obtener las transacciones por fundId
